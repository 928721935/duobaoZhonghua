...
/**
 * 12位（bit）可以表示的最大正整数是2^{12}-1 = 4095，
 * 即可以用0、1、2、3、....4094这4095个数字，
 * 来表示同一机器同一时间截（毫秒)内产生的4095个ID序号。
 *
 * 10bit-工作机器id，用来记录工作机器id。
 * - 可以部署在个节点，包括5位datacenterId和5位workerId
 * - 5位（bit）可以表示的最大正整数是，即可以用0、1、2、3、....31这32个数字，
...
public class SnowFlakeUtil {
    ...
    private static SnowFlakeUtil instance = null;
