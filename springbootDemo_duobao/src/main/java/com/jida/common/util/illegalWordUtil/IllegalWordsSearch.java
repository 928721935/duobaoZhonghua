package com.jida.common.util.illegalWordUtil;
...
public class IllegalWordsSearch extends BaseSearchEx {
    private static IllegalWordsSearch instance;

    public static IllegalWordsSearch getInstance(){
        if(instance == null){
            File file = CommonUtil.getClassPathFile("sensi_words.txt");
            List<String> list = loadKeywords(file);
            instance = new IllegalWordsSearch();
            instance.SetKeywords(list);
        }
        return instance;
    }
